...
## 機能候補
- ユーザー登録時に５項目のアンケートを実施。アンケート結果に合わせたおすすめスポットを表示。
- 一覧をタイル型レイアウトで実装し、カーソル先をホバーさせる。
- 公式のYouTube、SNS埋め込み機能
- 曖昧検索
- タグ、ジャンル、イベント、目的、要望、エリア、現在地からの検索機能
- レビュー投稿、星で評価
- ブックマーク
- 施設情報に画像と動画を掲載
- 検索履歴の保存機能
- ユーザー（の子供）全体から利用者層の統計表示

## 機能の実装方針予定
- マップはGoogle Maps Platformを利用
